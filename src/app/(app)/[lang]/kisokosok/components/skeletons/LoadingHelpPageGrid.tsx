...
export function LoadingHelpPageGrid() {
  return (
    <div className="bg-[#fffefc] border-x border-b border-[#e9e2d6] rounded-b-2xl p-4 md:p-8">
      <div className="flex flex-col gap-4">
        {Array.from({ length: 3 }).map((_, i) => (
          <div
            key={i}
            className="flex flex-col gap-4 rounded-2xl border border-[#e9e2d6] bg-white p-4 animate-pulse"
          >
            ...
            <div className="flex items-center justify-between gap-4 rounded-2xl border border-[#e9e2d6] bg-white p-4">
              <div className="flex flex-col gap-2">
                <div className="h-3 w-40 rounded bg-[#f0e9df]" />
