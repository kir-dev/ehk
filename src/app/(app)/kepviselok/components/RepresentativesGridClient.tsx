...
import { RepresentativeCard } from '@/app/(app)/kepviselok/components/RepresentativeCard';
import { RepresentativeModal } from '@/app/(app)/kepviselok/components/RepresentativeModal';
