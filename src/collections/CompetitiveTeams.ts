...
export const CompetitiveTeams: CollectionConfig = {
  slug: "competitive-teams",
  labels: {
    singular: "Versenycsapat",
    plural: "Versenycsapatok",
  },
  access: {
    read: () => true,
  },
  ...
  fields: [
    ...
    },
    {
      ...
      fields: [
        ...
        {
          name: "frequency_hu",
          label: "Gyakoriság / leírás (magyar)",
          type: "text",
        },
        {
          name: "frequency_en",
          label: "Gyakoriság / leírás (angol)",
          type: "text",
        },
      ],
    },
