          ...
          <div className="flex not-md:flex-col gap-2 md:gap-3">
            <div className="flex flex-col gap-2 md:gap-3">
                <p className="text-gray-700 text-lg richtext">{t(`Tanulmányi ösztöndíjban részesülhet az a hallgató, aki államilag támogatott vagy állami (rész)ösztöndíjas képzési formában vesz részt.`,
                    `A student may be granted a study scholarship if they are enrolled in a state-funded or state (partial) scholarship programme.`)}</p>
                <p className="text-gray-700 text-lg richtext">{t(`A tanulmányi ösztöndíjra nem kell pályázni, egy meghatározott elvrendszer alapján ítélik meg. Az összeg megállapításakor törekednek arra, hogy a homogén hallgatói csoportokon belül a jogosult hallgatók maximum 50%-a részesüljön ösztöndíjban. A tanulmányi ösztöndíj minimumösszege a hallgatói normatíva 5%-a (jelenleg 8 330 Ft).`,
                    `There is no need to apply for the study scholarship, as it is awarded on the basis of a defined set of principles. When determining the amount, an effort is made to ensure that within each homogeneous student group, a maximum of 50% of eligible students receive the scholarship. The minimum amount of the study scholarship is 5% of the student normative grant (currently HUF 8,330).`)}</p>
              <p className="text-gray-700 text-lg richtext">
                {t(
                  ...
                  `The basis for awarding the scholarship may be the scholarship index, the credit index or the corrected credit index, as determined by the Faculty Student Union in consultation with the Dean. Students are ranked within each homogeneous student group according to their academic performance in the previous active semester. For first-year Master’s students, the basis for awarding the scholarship may be their admission score, the number of points achieved at the entrance examination, or a combination of these. The Faculty Study Committee decides on the evaluation of academic results of students who have transferred from another higher education institution, programme or form of study, as well as those who have participated in a partial study programme abroad. First-year Bachelor’s and single-cycle students may only receive a study scholarship from the second semester onwards.`
                )}
              </p>
            </div>
          </div>
